            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    <div class="pull-right">
                        <a type="button" class="btn btn-primary btn-md" href="<?=base_url()?>cluster/k_means_lanjut">Proses Iterasi <li class="fa fa-arrow-right"></li></a>
                    </div>
                    <br><br>
                    <table class="table table-striped table-bmembered table-hover  dataTable table-bordered" id="editable" role="grid" aria-describedby="editable_info">
                        <thead>
                            <tr align="center">
                                <th>Nama Barang</th>
                              ...
                              <?php 
                              $s_data_ja = $this->M_general->get_('ambang_batas', '*', 'ORDER BY id_ambang_batas ASC');
                              $c1a = $s_data_ja[0]->batas_atas;
                              //echo '<br>';
                              $c1b = $s_data_ja[0]->batas_bawah;
                              //echo '<br>';
                              $c2a = $s_data_ja[1]->batas_atas;
                              //echo '<br>';
                              $c3b = $s_data_ja[1]->batas_bawah;
                              //echo '<br>';
                              $c3a = $s_data_ja[2]->batas_atas;
                              //echo '<br>';
                              $c3b = $s_data_ja[2]->batas_bawah;
                              //echo '<br>';
                            //die();
                              ?>
                        </thead>
                        <tbody>
                            ...
                            $this->db->query('truncate table centroid_produk_temp');
