...
<body>
	<center>
		...
		<hr style="width: 51%; border: 5px; color: black;">
	</center>
	<?php 
	if((isset($_GET['bulan']) && $_GET['bulan']!='') && (isset($_GET['tahun'])&&$_GET['tahun']!=''))
	 ...
	 <?php foreach ($print_slip as $ps): ?>
	 	<?php $potongan=$ps->alpha * $potongan; ?>
	 ...
	 <table class="table table-bordered table-striped mt-3">
	 	...
	 	<tr>
	 		...
	 		<th>Rp.<?php echo number_format($ps->gaji_pokok+$ps->tj_transport+$ps->uang_makan-$potongan,0,',','.') ?></th>
	...
	<table width="99%">
		<tr>
			...
			<td width="199px">
				<p>Yogyakarta, <?php echo date('y M Y') ?><br> Finance,</p>
				<br><br>
